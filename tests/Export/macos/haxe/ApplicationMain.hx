...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SimpleImage", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("file", "SimpleImage");
		app.meta.set("name", "Simple Image");
		app.meta.set("packageName", "org.openfl.lime.samples.simpleimage");
